/**
 * Standalone tsdown config for the dsh-model-capabilities plugin.
 *
 * Uses the vendored client-bundle preset (shared/tsdown.client.ts —
...
export default clientBundle('@linxin666/dsh-client-ui-model-capabilities', ['src/index.ts'])
