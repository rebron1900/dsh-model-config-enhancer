 ...
 *
 * Vendored from zhu1090093659/dsh-web `shared/tsdown.client.ts` so this
 * standalone package keeps the upstream artifact semantics (module-table
 * externals, bundle purity gate, CSS-module inlining). It sits at the repo
 * root here, so `REPOSITORY_ROOT` (one level up from shared/) resolves to
 * the same place it does upstream.
 */
